...
For the module to work, you need to deploy F<j4p-agent.war> to the JEE Server
...
The agent C<j4p-agent> can be switched into a history tracking mode, where it
