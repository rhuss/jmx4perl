...
called F<jolokia-access.xml.template>

=item 2. 

Copy this template to F<jolokia-access.xml> (all within the agent directory). 
...
A typical workflow looks like
 ...
 $ cd agent/
 $ cp jolokia-access.xml.template jolokia-access.xml
 ...
 $ jar tvf jolokia.war
  ...
  85124 Thu Jul 30 10:42:22 CEST 2009 WEB-INF/lib/jolokia-agent.jar
      0 Thu Jul 30 10:42:24 CEST 2009 WEB-INF/classes/jolokia-access.xml
 $ cp jolokia.war $DEPLOYMENT_DIR/
